...
<body>
				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="/proses_login" method="POST">
								{{ csrf_field() }}
								...
								<button type="submit" class="btn btn-primary btn-sm btn-block" onclick="login()">LOGIN</button>
								<a href="/register" type="button" class="btn btn-info btn-sm btn-block">REGISTER</a>
							</form>
						</div>
					</div>
					<div class="right">
	...
	<script>
		@if (Session::has('sukses'))
			function login() {
				swal("Selamat!", "{{ Session::get('sukses') }}", "success");
			};
		@endif
