	...
	<body>	
	  			...
	  			<div class="container">
			  		<div class="row">
			  			...
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
			  				<a href="{{ config('sekolah.telepon') }}"><span class="lnr lnr-phone-handset"></span> <span class="text">{{ config('sekolah.telepon') }}</span></a>
			  				<a href="{{ config('sekolah.email') }}"><span class="lnr lnr-envelope"></span> <span class="text">{{ config('sekolah.email') }}</span></a>			
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
		...
		<script>
			...
			@if (Session::has('error'))
			    toastr.warning("{{ Session::get('error') }}", "Gagal")
			@endif
		</script>
	</body>
</html>